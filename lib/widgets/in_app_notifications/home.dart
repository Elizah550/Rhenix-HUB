...
import 'package:precision_hub/widgets/in_app_notifications/second_screen.dart';
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      await service.showScheduledNotification(
                          id: 0,
                          title: 'Appointment',
                          body: 'You have an appoinment with Dr. Priyanka in an hour',
                          date: DateTime.now(),
                          seconds: 4,
                          doctoranme: "priyanka");
                    },
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      await service.showNotificationWithPayload(id: 0, title: 'Notification Title', body: 'Some body', payload: 'payload navigation');
                    },
