...
class _ProfilePageState extends State<ProfilePage> {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            print(
                                'phoneNum before calling deleteUserAccount: $phoneNum');
                            showDeleteConfirmationDialog(
                              context: context,
                              onConfirm: () async {
                                // Add your delete account logic here
                                deleteUserAccount(phoneNum);
                                ...
                                user.signOut();
                                // Navigate to the desired screen, in this case, the 'Code' screen
                      ...
                      //         onConfirm: () {
                      //           // Add your delete account logic here
                      //           deleteUserAccount(usersPavan,phoneNum);
                      //           Navigator.pushReplacement(
                      //             context,
                      //             MaterialPageRoute(
                      //                 builder: (context) => const Splash2()),
  ...
  Future<void> deleteUserAccount(String phoneNumber) async {
    try {
      ...
      final apiUrl =
          'https://i7kyqbulo9.execute-api.ap-south-1.amazonaws.com/Seniorcitizen_delete';
      print("-----------here---delete--credentials---------------");
      print(phoneNumber);
      // Construct the request body with the Users_Pavan key and the phone number
      final requestPayload = <String, dynamic>{
        'Users_Pavan': phoneNumber,
        'Phone': phoneNumber,
      };

      // Make a DELETE request to your API with the request payload
